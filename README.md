...
<sub>TideTwin 0.1.0 - commit `13b4a17` - seed 20260728 - OC4 geometry `d95a6af9a8c5` - LJF SHELL - tidal constants MEASURED: NOAA Mayport, FL (St John's entrance) - strongly rotary current, semidiurnal Atlantic. Current constants are from a bin at 3.69 m and are used as the depth-averaged current; the elevation gauge is 4.95 km from the current meter. - generated 2026-07-29T04:51:34Z</sub>
<!-- CLAIMS-LEDGER:END -->
